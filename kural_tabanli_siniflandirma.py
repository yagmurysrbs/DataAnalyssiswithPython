...
#nunique(): Bu, Pandas DataFrame sınıfının bir yöntemidir. Bu yöntem, belirli bir sütundaki
#benzersiz değerlerin sayısını döndürür. Yani, bir sütunda tekrarlanan tüm değerleri bir kez sayar.
df["SOURCE"].nunique()
